...
void Psychic_horf::AttackStart()
{
}

void Psychic_horf::AttackStay()
{
	float4 Dir = LogicValue::MainPlayer->GetPosition() - GetPosition();
	Dir.Normalize();
...
void Psychic_horf::DieStay()
{
	m_CharacterInfo->StopSpeed();
}

void Psychic_horf::DieEnd()
{
}

void Psychic_horf::StartCol(EngineCollision* _This, EngineCollision* _Other)
{
...
void Psychic_horf::StayCol(EngineCollision* _This, EngineCollision* _Other)
{
...
void Psychic_horf::EndCol(EngineCollision* _This, EngineCollision* _Other)
{
}
